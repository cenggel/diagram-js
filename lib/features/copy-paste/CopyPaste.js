...
import { getParents } from '../../util/CopyPasteUtil';
...
CopyPaste.prototype.paste = function(context) {
  ...
  this._create.start(this._mouse.getLastMousemoveEvent(), elements, {
    hints: hints || {}
  });
};
...
CopyPaste.prototype.createTree = function(elements) {
  ...
  var topLevel = getParents(elements);
  ...
  // (1) add elements
  eachElement(topLevel, function(element, _index, depth) {
